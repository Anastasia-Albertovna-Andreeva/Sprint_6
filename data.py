...
class TestDataUsers:
    user1_name = 'Александр'
    user1_surname = 'Смирнов'
    user1_address = 'Ленина, 25'
    user1_metro_station = 'Бульвар Рокоссовского'
    user1_phone = '+79001234567'
    user1_date = '23.09.2024'
    user1_comment = 'Домофон не работает!'

    user2_name = 'Екатерина'
    user2_surname = 'Петрова'
    user2_address = 'Садовая, 45'
    user2_metro_station = 'Строгино'
    user2_phone = '+79198765432'
    user2_date = '23.09.2024'
    user2_comment = 'Позвонить за 30 минут!'
